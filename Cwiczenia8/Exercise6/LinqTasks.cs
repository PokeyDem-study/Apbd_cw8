...
namespace Exercise6
{
    public static class LinqTasks
    {
        ...
        public static IEnumerable<Emp> Task2()
        {
            ...
            //Method syntax <-- better to use that than query syntax
            result = Emps
        ...
        public static IEnumerable<object> Task5()
        {
            ...
            //Method syntax
            result = Emps.Select(e => new {Nazwisko = e.Ename, Praca = e.Job}); // obiekt anonimowy
        ...
        public static IEnumerable<object> Task7()
        {
            ...
            result = Emps.GroupBy(e => e.Job).Select(e => new
            {
                Praca = e.Key,
        ...
        {
            bool result = Emps.Where(e => e.Job.Equals("Backend programmer")).Count() > 0;
            return result;
        }
